...
class UnificationVariable(name: String, t: Term? = null) : Placeholder(name, t), Term, TermContainer {
    ...
    override fun clone(): Term = UnificationVariable(name, value)
    ...
    override fun simplifier(): Simplifier<*> = object : Simplifier<UnificationVariable> {
        ...
        override fun flatten(t: UnificationVariable): Term = if (t.t != null) (t.t!! as Term).flatten() else t
